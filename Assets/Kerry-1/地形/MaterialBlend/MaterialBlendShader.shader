Shader "CALF/MaterialBlend"
{
    Properties
    {
        ...
        //Layer01
        _Layer1_Tilling("Layer1 Tilling",Float) = 2
        _Layer1_BaseColor("Layer1 BaseColor",2D) = "white" {}
        ...
        //Layer02
        _Layer2_Tilling("Layer2 Tilling",Float) = 2
        _Layer2_BaseColor("Layer2 BaseColor",2D) = "white" {}
        ...
        //Layer03
        _Layer3_Tilling("Layer3 Tilling",Float) = 2
        _Layer3_BaseColor("Layer3 BaseColor",2D) = "white" {}
        ...
        //Layer04
        _Layer4_Tilling("Layer4 Tilling",Float) = 2
        _Layer4_BaseColor("Layer4 BaseColor",2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings IN) : SV_Target
            {
                ...
                float2 uw1 = IN.uv * _Layer1_Tilling;
                float4 layer1_baseColor = SAMPLE_TEXTURE2D(_Layer1_BaseColor,sampler_Layer1_BaseColor, uw1);
                ...
                float2 uv2 = IN.uv * _Layer2_Tilling;
                float4 layer2_baseColor = SAMPLE_TEXTURE2D(_Layer2_BaseColor,sampler_Layer2_BaseColor, uv2);
                ...
                float2 uv3 = IN.uv * _Layer3_Tilling;
                float4 layer3_baseColor = SAMPLE_TEXTURE2D(_Layer3_BaseColor,sampler_Layer3_BaseColor, uv3);
                ...
                float2 uv4 = IN.uv * _Layer4_Tilling;
                float4 layer4_baseColor = SAMPLE_TEXTURE2D(_Layer4_BaseColor,sampler_Layer4_BaseColor, uv4);
