Shader "HJZG/Hair"
{
    Properties
    {
        ...
        [ToggleUI] _StaticSpecularHighlight("Static Specular Highlight", Float) = 0.0
        _StaticLightColor("Static Light Color", Color) = (1,1,1,1)
        _StaticLightVector("Static Light Vector", Vector) = (0.0, 0.0, 0.0, 1.0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment _STATICSPECULARHIGHLIGHT_ON
        ...
        Pass
        {
            ...
            #pragma fragment FragmentMetaHair
    ...
    CustomEditor "KeroTools.URPPlus.Editor.ShaderGUI.HairGUI"
}
