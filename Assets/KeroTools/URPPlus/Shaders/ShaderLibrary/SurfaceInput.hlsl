...
half4 SampleMaskMap(float2 uv, TEXTURE2D_PARAM(maskMap, sampler_maskMap), half4 metallicSmoothnessRemap, half2 aoRemap, half4 MAODS)
{
        ...
        maskValues.g = RemapValue(maskValues.g, metallicSmoothnessRemap.zw);  //RemapValue(maskValues.g, aoRemap);
        maskValues.b = RemapValue(maskValues.b, aoRemap);
        maskValues.a = maskValues.a;
